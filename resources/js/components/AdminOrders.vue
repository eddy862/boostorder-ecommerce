<template>
  <section class="space-y-6">
    <div
      class="flex flex-col gap-3 rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 px-6 py-8 text-white shadow-xl shadow-slate-300 sm:flex-row sm:items-end sm:justify-between">
      <div>
    ...
    <div class="flex flex-wrap gap-2">
      <button @click="selectedStatus = 'all'" class="rounded-xl border px-4 py-2 text-sm font-semibold transition"
      ...
      <button @click="selectedStatus = 'pending'" class="rounded-xl border px-4 py-2 text-sm font-semibold transition"
      ...
      <button @click="selectedStatus = 'cancelled'" class="rounded-xl border px-4 py-2 text-sm font-semibold transition"
      ...
      <button @click="selectedStatus = 'completed'" class="rounded-xl border px-4 py-2 text-sm font-semibold transition"
        ...
        <article v-for="order in filteredOrders" :key="order.id"
          ...
          <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex items-center gap-3">
              ...
              <button v-if="order.status === 'pending'" @click="completeOrder(order)"
